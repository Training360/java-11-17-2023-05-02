...
## Extensions Mechanism eltávolítása

* `${java.home}/lib/ext` könyvtárban lévő jar fájlok nem kerülnek felolvasásra
* `java.ext.dirs` system property nem kerül értelmezésre
